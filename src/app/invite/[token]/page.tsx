  ...
  return (
    <main className="flex flex-1 items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <h1 className="mb-1 text-lg font-semibold text-gray-900">組織への招待</h1>
        <p className="mb-5 text-sm text-gray-500">
          「{invite.orgName}」に <b className="text-gray-900">{ROLE_LABEL[invite.role]}</b> として招待されています。
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input
              value={invite.email}
              disabled
              className="rounded-md border border-gray-200 bg-gray-100 px-3 py-1.5 text-sm text-gray-500"
            />
          </label>
          <label className="flex flex-col gap-1 text-sm">
